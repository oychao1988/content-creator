...
describe.skipIf(isRedisDisabled)('@performance CacheService Benchmarks', () => {
  ...
  describe('Single Operation Performance', () => {
    it('should complete 1000 SET operations in < 120 seconds', async () => {
    ...
    it('should complete 1000 GET operations in < 120 seconds', async () => {
      // 先设置数据
      for (let i = 0; i < 1000; i++) {
        await cacheService.set(`key${i}`, `value${i}`);
      }
    ...
    it('should complete 1000 DELETE operations in < 120 seconds', async () => {
      // 先设置数据
      for (let i = 0; i < 1000; i++) {
        await cacheService.set(`key${i}`, `value${i}`);
      }
  ...
  describe('Cache Hit Rate Performance', () => {
    it('should demonstrate > 30% hit rate with proper caching strategy', async () => {
