...
| 文档 | 说明 |
|------|------|
| [BullMQ 快速参考](./docs/references/bullmq-quick-reference.md) | 任务队列快速入门 |
| [监控优化指南](./docs/references/monitoring-optimization-guide.md) | 系统监控和优化 |
| [性能优化指南](./docs/references/performance-optimization-guide.md) | 应用性能调优 |

### 历史文档

项目开发历史已归档到：[📦 docs/archive/](./docs/archive/)
...
项目分为 4 个阶段渐进式开发，所有阶段已归档到 [docs/archive/phases/](./docs/archive/phases/)
...
| 项目 | 月度成本 |
|------|----------|
| DeepSeek API（LLM） | ¥300-500 |
| Doubao API（图片生成） | ¥50-100 |
| 内容审核 | ¥7 |
| PostgreSQL（云数据库） | ¥100-200 |
| Redis（云缓存） | ¥50-100 |
| 对象存储（S3/OSS） | ¥10-20 |
| 监控服务（Sentry） | 免费额度 |
| **总计** | **¥500-900/月** |
...
**核心功能完成度**：
- ✅ 结果持久化 - 完整实现 (SyncExecutor: saveResults)
- ✅ 图片生成 - 豆包真实 API (ImageService)
- ✅ 质量检查 - 硬规则 + LLM 双层检查
- ✅ 多工作流架构 - 插件化扩展支持
- ✅ AI 脚手架 - 自然语言生成工作流
